...
const CrimeImages = [
  require("../assets/imgs/robbery/1.png"),
  require("../assets/imgs/robbery/3.png"),
  require("../assets/imgs/robbery/4.png"),
  require("../assets/imgs/robbery/5.png"),
  require("../assets/imgs/robbery/2.png"),
  require("../assets/imgs/robbery/6.png"),
];
